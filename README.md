...
UI button icons (recolored white, in [`qt_app/icons/`](qt_app/icons/)) are from
[**Font Awesome Free**](https://fontawesome.com) 6.4.2 (CC BY 4.0), except the Mode button's
rabbit/turtle, which are [**Material Design Icons**](https://pictogrammers.com/library/mdi/)
